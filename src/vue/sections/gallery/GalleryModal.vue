...
<template>
   <!-- Bootstrap Modal -->
   <div :id="UNIQUE_ID" class="modal modal-xl fade" tabindex="-1" :aria-labelledby="`${UNIQUE_ID}-label`" aria-hidden="true">
               ...
               <div class="row text-center text-lg-start p-2 p-md-4">
                  ...
                  <div class="col-12 col-lg-8">
                     ...
                     <div class="modal-subsection">
                        ...
                        <!-- Content -->
                        <p class="text-3 text-light-7" v-html="props.project.locales.description" />
                     </div>
                     ...
                     <div class="modal-subsection">
                        ...
                        <p
                           ...
                           v-html="data.getString('whereToFindDescription').replace('${project}', `<strong>${props.project.title}</strong>`)"
                        />
