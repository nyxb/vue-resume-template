...
/**
/**
 * @property {object[]} items - The array of items.
 */
      ...
      <div v-for="item in props.items" class="col-12 col-md-6">
         ...
         <div class="contact-item">
            ...
            <div class="contact-item-content">
               ...
               <!-- Item Link... -->
               <a v-if="item.href" :href="item.href" class="text-3 muted" target="_blank" v-html="_getItemLabel(item)" />

               <!-- Fallback (if there's not a link...) -->
               <p v-else class="text-3 text-muted mb-0" v-html="_getItemLabel(item)" />
            </div>
         </div>
      </div>
   </div>
